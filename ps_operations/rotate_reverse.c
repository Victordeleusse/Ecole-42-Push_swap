...
/*   Updated: 2023/01/08 17:55:19 by vde-leus         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_rotate_a(t_stack_list **stack_a, int *count, t_instruction_list **instruction_list)
{
...
void	ft_rotate_b(t_stack_list **stack_b, int *count, t_instruction_list **instruction_list)
{
	t_stack_list	*extract;
	char			*instruction;
...
void	ft_reverse_rotate_a(t_stack_list **stack_a, int *count, t_instruction_list **instruction_list)
{
	t_stack_list	*extract;
	char			*instruction;
...
void	ft_reverse_rotate_b(t_stack_list **stack_b, int *count, t_instruction_list **instruction_list)
{
	t_stack_list	*extract;
	char			*instruction;
...
void	ft_double_reverse_rotate(t_stack_list **stack_a, \
	t_stack_list **stack_b, int *count, t_instruction_list **instruction_list)
{
