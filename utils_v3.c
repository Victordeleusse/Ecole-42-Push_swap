...
/*   Updated: 2023/01/08 18:04:06 by vde-leus         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort_3(t_stack_list **stack_a, int *count, int size_stack_a, t_instruction_list **instruction_list)
{
	...
	if (pos == 0)
		ft_case_beginning(stack_a, count, instruction_list);
	else if (pos == 2)
		ft_case_end(stack_a, count, size_stack_a, instruction_list);
	else
		ft_case_middle(stack_a, count, size_stack_a, instruction_list);
	return ;
}
