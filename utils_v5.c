...
/*   Updated: 2023/01/10 11:12:15 by vde-leus         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_prepare_stack_2(t_stack_list **stack2, t_instruction_list **instruction_list)
{
	t_stack_list	*begin2;
...
void	ft_sort_5(t_stack_list **stack1, t_stack_list **stack2, t_instruction_list **instruction_list)
{
	int				size_stack1;
	int				mediane_index;
